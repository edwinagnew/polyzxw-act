...
\newcommand{\wstate}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
...
\newcommand{\zspid}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=gn] (0) at (0, 0) {};
...
\newcommand{\xspid}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=rn] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, -0.5) {};
		\node [style=none] (2) at (-0.5, -0.5) {};
...
\newcommand{\coZ}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=gn] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, 0.5) {};
		\node [style=none] (2) at (-0.5, 0.5) {};
...
\newcommand{\coX}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=rn] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, 0.5) {};
		\node [style=none] (2) at (-0.5, 0.5) {};
...
\newcommand{\wspid}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=uw] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, -0.5) {};
		\node [style=none] (2) at (-0.5, -0.5) {};
...
\newcommand{\xspids}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=rn] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, -0.5) {};
		\node [style=none] (2) at (-0.5, -0.5) {};
...
\newcommand{\coZs}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=gn] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, 0.5) {};
		\node [style=none] (2) at (-0.5, 0.5) {};
...
\newcommand{\coXs}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style=rn] (0) at (0, 0) {};
		\node [style=none] (1) at (0.5, 0.5) {};
		\node [style=none] (2) at (-0.5, 0.5) {};
...
\newcommand{\zgate}[2][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
...
\newcommand{\xgate}[1][0.4]{\begin{tikzpicture}[scale=#1]
	\begin{pgfonlayer}{nodelayer}
		\node [style={rn_phase}] (0) at (0, 0) {$\pi$};
		\node [style=none] (3) at (0, 0.75) {};
		\node [style=none] (4) at (0, -0.75) {};
...
\newcommand{\numberbox}[1][a]{\begin{tikzpicture}[scale=0.5]
	\begin{pgfonlayer}{nodelayer}
