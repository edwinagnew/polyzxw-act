...
Recently, one of the new rules for controlled diagrams first proposed in this work, \eqref{rule:CMcpy}, was used in Ref.~\cite{mcdowallrose2025f2q} to derive a general form for any two-body fermionic Hamiltonian in second quantization under any linear encoding.
