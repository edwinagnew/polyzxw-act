\begin{abstract}
    ...
    By formalising these properties of quantum control as a higher-order map, we enable powerful new graphical rewrite rules, going beyond prior calculi for which the allowed parameters are restricted to phases and generator arity.
