...
Now we show that controlled matrix addition and multiplication satisfy the ring axioms. Associativity of $+, \times$ follow immediately from (\ref{rule:Aso}, \ref{rule:S1}), respectively. Commutativity of addition is just (\ref{rule:CMcom}). The remaining ring properties are as follows:
...
Several of the ring axioms follow directly from basic ZXW rules, such as commutativity of addition:
