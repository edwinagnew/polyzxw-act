...
There are only five Controlled Ring Rules necessary to derive the new completeness results in this work, presented in Figure~\ref{fig:zxw_rules}.
All other diagrammatic equalities in this paper were proven using only the rules in Figure~\ref{fig:zxw_rules}. We verify the soundness of the rules for controlled diagrams in Appendix~\ref{sec:csound} by plugging in basis states.
