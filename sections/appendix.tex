...
The soundness of axioms $\ref{rule:c_sq0}$, $\ref{rule:c_sq1}$, $\ref{rule:cstate0}$, and $\ref{rule:cstate1}$ with respect to the interpretations in Equations~\eqref{eq:ctrlsqinterp} and~\eqref{eq:ctrlstateinterp}, immediately follows from applying the control states $\left\llbracket\tikzfig{tikz/lemmas/x0}\right\rrbracket = \ket{0}$ and $\left\llbracket\tikzfig{tikz/lemmas/x1}\right\rrbracket = \ket{1}$ respectively.
