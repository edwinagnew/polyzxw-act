...
First, we verify the soundness of the axioms for controlled diagrams by plugging in basis states. Rules (\ref{rule:c_sq0}) and (\ref{rule:c_sq1}) follow immediately from definition (\ref{def:ctrlsqmat}), whilst rules(\ref{rule:cstate0}) and (\ref{rule:cstate1}) follow immediately from definition (\ref{def:ctrlst}).
