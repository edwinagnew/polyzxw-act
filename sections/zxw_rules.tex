  ...
  \begin{tabular}{|p{0.45\textwidth}|p{0.45\textwidth}|}
    ...
    \begin{minipage}{\linewidth}
      \begin{gather*}
        ...
        \tag{Rcpy}\label{rule:Rcpy} 
      \end{gather*}
    \end{minipage} &
    \begin{minipage}{\linewidth}
      \begin{gather*}
        \scalebox{0.75}{\tikzfig{tikz/con/csq_add_comm_statement}}
        \tag{Rcom}\label{rule:Rcom}
      \end{gather*}
    \end{minipage} \\
    \hline
  \end{tabular}
  \caption{The ZXW Calculus Rules, where $k \in \{0, 1\}$ and $a \in \mathbb{C}$. The ZX rules, ZW rules, and ZXW rules are sufficient for ZXW completeness, while the controlled ZXW ring rules are additionally required for Theorem \ref{thm:ctrl_pnf}.}
  \label{fig:zxw_rules}
\end{figure}