\begin{figure}[htbp]
  ...
  \begin{tabular}{|p{0.45\textwidth}|p{0.45\textwidth}|}
    ...
    \end{minipage} \\ 
    \hline
    \multicolumn{2}{|c|}{\textbf{Controlled ZXW Ring Rules}} \\
    \hline
    \begin{minipage}{\linewidth}
      \begin{gather}
    ...
    \begin{minipage}{\linewidth}
      \begin{gather}
        ...
        \tag{M0}\label{rule:c_sq1} \\
        \scalebox{0.85}{\tikzfig{tikz/con/csq_copy}}
    ...
    \hline
  \end{tabular}
  \caption{The ZXW Calculus Rules, where $k \in \{0, 1\}$ and $a \in \mathbb{C}$. The ZX rules, ZW rules, and ZXW rules are sufficient for ZXW completeness~\cite{poor2023completeness}, while the controlled ZXW ring rules are additionally required for Theorem \ref{thm:ctrl_pnf}.}
  \label{fig:zxw_rules}
\end{figure}